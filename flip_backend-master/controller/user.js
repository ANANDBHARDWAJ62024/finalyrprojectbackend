...
router.post('/signin',async(req,res)=>{
 ...
 // after  login  to get profile details
router.get('/',auth,async(req,res)=>{
 ...
 // to get all user details for admin purpose 
router.get('/alluser',(req,res)=>{
  ...
  // for admin to delete or restrict a user
...
router.post('/operation',async(req,res)=>{
  ...
  let b=req.body.b;
  let add=a+b
  res.status(205).send({status:"success",message:"sum",sum:add})
...
router.post('/multiplication',async(req,res)=>{
  ...
  let y=req.body.y;
  let mul=x*y
  res.status(205).send({status:"success",message:"mul",mul:mul})
...
router.post('/loginp',async(req,res)=>{
  ...
  res.status(206).send({status:"success",message:"registration successfull",name:name,email:email,password:password,phone:phone})
})
